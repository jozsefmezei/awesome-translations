...
- [Respresso](https://respresso.io/) - Collaborative online resource manager for localizations and translations, images, colors, etc. that generates platform-specific files and delivers them directly to your source code.
